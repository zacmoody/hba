...
<!-- *********************** second section ends here ****************** -->               
      ...
      <!-- CARAOUSAL -->
      <?php include("./includes/caraousalBar.php"); ?>
      <!-- CARAOUSAL -->

      <!-- BLUE STRIP -->
      <?php include("./includes/blueBar.php"); ?>
      <!-- BLUE STRIP -->

      <!-- MAIN CONTENT SECTION -->
      <section class="mainContent clearfix">
        <div class="container">
<!-- **********************   for featured, 4 items to be placed********************* -->          
          <?php include("./includes/featuredCollection.php"); ?>

          <?php include("./includes/featuredProducts.php"); ?>

          <?php include("./includes/brandsByCategoryList.php"); ?>
      ...
      <!-- LOGO SECTION -->
      <?php //include("./includes/brandsLogoList.php"); ?>
      <!-- LOGO SECTION -->
